...
document.addEventListener("DOMContentLoaded", function(){
    (function (){
        const formBind = document.querySelector('form#form-question');
        ...
        const urlPage=(new URL(document.location))
        if(urlPage.searchParams.has('show-question')){
            const formSection = document.querySelector('section.form-questions')
            formSection && (formSection.style.display="")
        }
